...
async def get_current_weather_data_impl(city: str, country: str, coordinates: dict | None = None) -> dict:
    ...
    return {
        ...
        "conditions": "mock_value",
        "humidity": 0,
        "wind_speed": 0,
        "wind_direction": "mock_value",
        "pressure": 0,
        "visibility_km": 0,
        "uv_index": 0,
        "weather_alerts": [],
...
async def get_safety_guidelines_impl(hazard_type: str, severity_level: str) -> dict:
    ...
    return {
        "safety_guidelines": "MOCK_ID_001",
        "evacuation_info": "mock_value",
        "emergency_supplies": None,
    }
...
async def get_weather_forecast_impl(city: str, country: str, forecast_days: int | None = None, include_hourly: bool | None = None) -> dict:
    ...
    return {
        "daily_forecast": [],
        "hourly_forecast": [],
        "forecast_confidence": "MOCK_ID_001",
        "weather_trends": "mock_value",
    }
